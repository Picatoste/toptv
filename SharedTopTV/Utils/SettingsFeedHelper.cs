...
namespace TopTV.Utils
{
    public static class SettingsFeedHelper
    {
        ...
        public static List<FeedItemsModel> SaveFeeds(List<FeedItemsModel> feeds, DateTime lastDate)
        {
        ...
        public static List<FeedItemsModel> SaveFeeds(SyndicationItem[] feedsSyndication)
        {
            return SettingsFeedHelper.SaveFeeds(SettingsFeedHelper.ConvertFeeds(feedsSyndication), DateTime.Now);
        }
