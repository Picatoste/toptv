...
SocialSharingView = Backbone.View.extend({
  ...
  template:
	'<div class="fb-like" data-href="http://solucionesdbr.es/pages/solucion-14-wp8-crear-tile-user-control.html" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>' +
